      ...
      <AlertDialog>
        <AlertDialogTrigger asChild>
          <Button
            ...
            disabled={cart.total - 315 === 0 || cart.total - 315 < 0}
          >
            Check Out
          </Button>
        </AlertDialogTrigger>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>You are checking out</AlertDialogTitle>
            <AlertDialogDescription>
              All purchases are final. Are you sure you want to proceed?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
